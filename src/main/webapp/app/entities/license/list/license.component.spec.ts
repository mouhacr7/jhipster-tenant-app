...
describe('License Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'license', component: LicenseComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to licenseService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLicenseIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLicenseIdentifier).toHaveBeenCalledWith(entity);
