...
import com.tenant.app.JhipstertenantappApp;
import com.tenant.app.config.AsyncSyncConfiguration;
import com.tenant.app.config.EmbeddedSQL;
...
@SpringBootTest(classes = { JhipstertenantappApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
